  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <?php
        ...
        if(isset($_GET["one"])){
          $res = $usr->task_one($_GET["one"]);
        }
        if(isset($_GET["two"])){
          $res = $usr->task_two($_GET["two"]);
        }
        if(isset($_GET["three"])){
          $res = $usr->task_three($_GET["three"]);
        }
      ?>
      <div class="content">
        <div class="container-fluid">
...
// //var_dump($difference);
        ...
        <?php }else if(Session::get('User_id') !='' && Session::get('type') ==1){?>
          <div class="row">
            <div class="col-md-12"> 
              <button id="show_ticket" class="btn btn-warning"> Add Task</button>
              <button id="hide_ticket" class="btn btn-warning">Cancel</button>
            </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input name="title" style="background-color: #191e32;" type="text" class="form-control">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <textarea rows="6" style="background-color: #191e32;" name="details" type="text" class="form-control"></textarea>
                          </div>
                        </div>
                      </div>
                      <br>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input name="dead" style="background-color: #191e32;" type="date" class="form-control">
                          </div>
                        </div>
                      </div>
                      <br>
                      <center><button type="submit" class="btn btn-primary" name="add">Save</button></center>
                      <div class="clearfix"></div>
                  </form>
                </div>
              </div>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            ?>
                            <input type="text" name="note" value="<?php echo $n['notes'];?>">
                          </td>
                          <td><?php echo $row["date_created"];?></td>
                          <td><?php echo $row["deadline"];?></td>
                          <td>
                            <?php if(Session::get('dept_id') == $row["dept_id"]){ ?>
                              <a class="btn btn-info" href="?one=<?php echo $row['task_id'];?>">Waiting</a>
                                <a class="btn btn-info" href="?change=<?php echo $row['task_id']?>">Change Department</a>
                             <?php } if(Session::get('dept_id') != $row["dept_id"]){ ?>
                                    <p class="btn btn-info">Waiting</p>
                              <?php }?>
                          </td>
                        </tr>
                        <?php }}?>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
                          $res = $emp->Get_All_Task_by_dept_0(Session::get('dept_id'));
                          if($res){
                            while ($row = $res->fetch_assoc()) {
                              $id = $row["dept_id"];
                              $re= $usr->get_dept_by_id($id);
